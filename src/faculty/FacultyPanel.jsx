...
import StudentProfileCreateComponent from "../common/StudentProfileCreateComponent";
import AssignedCoursesComponent from "./AssignedCoursesComponent";
import FacultySideBar from "../components/FacultySideBar";
import AssignedStudentsComponent from "./AssignedStudentsComponent";
  ...
  const renderSelectedComponent = () => {
    switch (selectedComponent) {
      ...
      case "assignedCourses":
        return <AssignedCoursesComponent />;
