...
import CourseAssignmentComponent from "./CourseAssignmentComponent";
import CreateDepartmentComponent from "./CreateDepartmentComponent";
import CreateFacultyComponent from "./CreateFacultyComponent";
...
const AdminPanel = () => {
  ...
  const renderSelectedComponent = () => {
    switch (selectedComponent) {
      ...
      case "createFaculty":
        return <CreateFacultyComponent />;
      case "editProfile":
        return <EditProfileComponent />;
      case "courseAssignment":
        return <CourseAssignmentComponent />;
      case "changePassword":
